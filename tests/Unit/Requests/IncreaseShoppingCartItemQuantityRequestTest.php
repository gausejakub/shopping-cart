...
final class IncreaseShoppingCartItemQuantityRequestTest extends UnitTestCase
{
    /** @test */
    public function authorize_method_returns_true(): void
    {
        $request = new IncreaseShoppingCartItemQuantityRequest();
    ...
    public function handle_method_returns_true_when_decrease_quantity_method_returns_true(): void
    {
        ...
        ShoppingCartItemFacade::shouldReceive('increaseQuantity')
            ->andReturn(true)
            ->once();

        /** @var IncreaseShoppingCartItemQuantityRequest $request */
        $request = \Mockery::mock(IncreaseShoppingCartItemQuantityRequest::class)->makePartial();
